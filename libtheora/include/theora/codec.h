...
THEORA_EXTERN const char *th_version_string(void);
...
THEORA_EXTERN ogg_uint32_t th_version_number(void);
...
THEORA_EXTERN ogg_int64_t th_granule_frame(void *_encdec,ogg_int64_t _granpos);
 ...
 * \retval -1 The given granule position was invalid (i.e. negative).*/
THEORA_EXTERN double th_granule_time(void *_encdec,ogg_int64_t _granpos);
...
THEORA_EXTERN int th_packet_isheader(ogg_packet *_op);
...
THEORA_EXTERN int th_packet_iskeyframe(ogg_packet *_op);
/*@}*/
...
THEORA_EXTERN void th_comment_init(th_comment *_tc);
...
THEORA_EXTERN void th_comment_add(th_comment *_tc, char *_comment);
/**Add a comment to an initialized #th_comment structure.
 * \note Neither th_comment_add() nor th_comment_add_tag() support
 *  comments containing null values, although the bitstream format does
 *  support them.
...
THEORA_EXTERN void th_comment_add_tag(th_comment *_tc,char *_tag,char *_val);
...
THEORA_EXTERN char *th_comment_query(th_comment *_tc,char *_tag,int _count);
...
THEORA_EXTERN int th_comment_query_count(th_comment *_tc,char *_tag);
...
THEORA_EXTERN void th_comment_clear(th_comment *_tc);
/*@}*/
/*@}*/
