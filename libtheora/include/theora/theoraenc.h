...
THEORA_EXTERN const th_quant_info TH_VP31_QUANT_INFO;

/**The Huffman tables used by VP3.*/
THEORA_EXTERN const th_huff_code
...
THEORA_EXTERN th_enc_ctx *th_encode_alloc(const th_info *_info);
...
THEORA_EXTERN int th_encode_ctl(th_enc_ctx *_enc,int _req,void *_buf,size_t _buf_sz);
...
THEORA_EXTERN int th_encode_flushheader(th_enc_ctx *_enc,
 ...
 *                    completed.*/
THEORA_EXTERN int th_encode_ycbcr_in(th_enc_ctx *_enc,th_ycbcr_buffer _ycbcr);
...
THEORA_EXTERN int th_encode_packetout(th_enc_ctx *_enc,int _last,ogg_packet *_op);
/**Frees an allocated encoder instance.
 * \param _enc A #th_enc_ctx handle.*/
THEORA_EXTERN void th_encode_free(th_enc_ctx *_enc);
/*@}*/
/*@}*/
